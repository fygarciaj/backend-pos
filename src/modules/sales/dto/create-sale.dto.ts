...
export class CreateSaleDto {
  @ApiPropertyOptional({
    description: 'UUID of the customer associated with the sale',
  ...
  @ApiPropertyOptional({
    description: 'Discount amount applied to the total sale',
    example: 5.0,
  })
  ...
  @ApiPropertyOptional({
    description: 'Discount percentage applied to the total sale',
    example: 10.0,
  })
  @IsDecimal({ decimal_digits: '2' })
  @Min(0)
  ...
  @ApiPropertyOptional({
    description: 'Notes or comments about the sale',
    example: 'Cliente pidió envolver para regalo.',
  })
  @IsString()
  @IsOptional()
  notes?: string;
