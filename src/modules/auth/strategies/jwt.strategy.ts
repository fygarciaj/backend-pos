...
@Injectable()
export class JwtStrategy extends PassportStrategy(Strategy) { // Usa 'jwt' como nombre por defecto
  constructor(
  ...
  async validate(payload: JwtPayload): Promise<any> {
    ...
    console.log(`JwtStrategy: Validation successful for user ${user.username} (ID: ${user.id})`); // Log para depuración
