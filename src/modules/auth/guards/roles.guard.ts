...
export class RolesGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    if (!user || !user.roles) {
        ...
        throw new ForbiddenException('User information is missing for role check.');
    }
    ...
    if (!hasRequiredRole) {
        ...
        throw new ForbiddenException(`You do not have the necessary permissions (${requiredRoles.join(', ')}) to access this resource.`);
    }
